...
namespace BlogTrackerMVC.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public BlogInfoesController(ProjectDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BlogInfo != null ? 
                          ...
                          Problem("Entity set 'ProjectDbContext.BlogInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjectDbContext.BlogInfo'  is null.");
            }
            var blogInfo = await _context.BlogInfo.FindAsync(id);
            if (blogInfo != null)
            {
