...
namespace BlogTrackerMVC.Controllers
{
    public class EmpInfoesController : Controller
    {
        ...
        public EmpInfoesController(ProjectDbContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EmpInfo != null ? 
                          ...
                          Problem("Entity set 'ProjectDbContext.EmpInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'ProjectDbContext.EmpInfo'  is null.");
            }
            var empInfo = await _context.EmpInfo.FindAsync(id);
            if (empInfo != null)
            {
