...
namespace BlogTrackerMVC.Controllers
{
    public class AdminInfoesController : Controller
    {
        ...
        public AdminInfoesController(ProjectDbContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AdminInfo != null ? 
                          ...
                          Problem("Entity set 'ProjectDbContext.AdminInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'ProjectDbContext.AdminInfo'  is null.");
            }
            var adminInfo = await _context.AdminInfo.FindAsync(id);
            if (adminInfo != null)
            {
